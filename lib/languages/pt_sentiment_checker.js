...
var frStopWords = fs.readFileSync(__dirname + '/pt-stop.js', 'utf-8');
var ptSentiment = fs.readFileSync(__dirname + '/pt-sentiment.json', 'utf-8');
var ptNegationWords = require(__dirname + '/pt-neg.js');
//add in different language lists here put them in a varible with the name of the language
ptSentiment = JSON.parse(ptSentiment);
